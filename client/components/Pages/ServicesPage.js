...
export const ServicesPage = (props) => {
  return (
    <ServicesContainer>
      ...
      <p style={{textDecoration: "underline rgb(202,223,235) 2px", fontSize: 20+'px'}}>Something you’d like isn’t listed here? Feel out <Link to="/contact" style={{textDecoration: "none", color: "rgb(158, 174, 183)"}}>this short form</Link> and I will get back to you asap!</p>
    </ServicesContainer>
  );
};
